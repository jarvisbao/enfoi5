  ...
  <div class="myroles-add">
    <el-form ref="form" v-loading="loading" :model="items" :rules="rules" class="demo-form-inline" label-width="120px">
      ...
      <el-form-item label="角色" prop="role">
        <el-input v-model="position_name" :disabled="true" />
      </el-form-item>
      <el-form-item>
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          const position_code = this.position_code
          this.$Apis.organize.CreatePositionUser(user_id, position_code).then(response => {
            this.loading = false
