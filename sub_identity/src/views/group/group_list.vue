<template>
  <div class="app-container">
    ...
    <div class="action-btn clearfix">
      ...
      <div v-if="removePermission" class="btn create-btn delete" @click="group_delete(groupids)">
        注销所选
      </div>
      <div v-if="removePermission" class="btn create-btn delete" @click="active_group(groupids)">
        激活所选
      </div>
      <div class="right-btn">
