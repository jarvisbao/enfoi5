<template>
  <div class="actions-box">
    <el-form ref="form" :model="actions" :rules="rules" label-width="170px">
      ...
      <el-form-item label="动作包含的字段" prop="attributes">
      ...
      <el-form-item label="扩展属性" prop="props">
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.loading = true
          this.$Apis.resource.actions_create(namespace, action_name, action_label, can_execute, can_create, can_update, can_delete, can_view, attributes, is_children, is_self, props).then(response => {
            this.loading = false
