<template>
  <div>
    <el-form ref="form" :model="attributes" :rules="rules" label-width="160px">
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.loading = true
          this.$Apis.resource.attributes_create(namespace, attr_name, attr_label, attr_type, is_children, is_self, props).then(response => {
            this.loading = false
