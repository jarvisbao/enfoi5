<template>
  <div class="app-container">
    ...
    <div class="action-btn">
      ...
      <div v-if="removePermission" class="btn create-btn delete" @click="role_deletes">
        注销所选
      </div>
      <div v-if="removePermission" class="btn create-btn delete" @click="active_roles">
        激活所选
      </div>
      <div class="right-btn">
