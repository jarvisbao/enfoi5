  ...
  data() {
    return {
      property: {
        prop_name: null,
        prop_code: '',
        prop_decorator: 'hybrid_property',
        prop_comment: null,
        params: null
      },
      rules: {
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.$Apis.class.property_create(repo_name, class_name, prop_name, prop_decorator, prop_code, prop_comment, params).then(response => {
