<template>
  <div class="app-container">
    <el-form ref="pageForm" :model="page" :rules="rules" :disabled="true" label-width="170px">
      <el-tabs v-model="activeName" type="card">
        <el-tab-pane label="基本信息" name="first">
          ...
          <el-form-item label="页面显示字段" prop="fields">
            <el-select id="pageFields" v-model="page.fields" multiple clearable filterable>
              <el-option
    ...
    <el-button plain style="margin-left: 170px;" @click="resetForm('pageForm')">
      返回
    </el-button>
  </div>
</template>
