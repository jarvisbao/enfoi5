    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$Apis.object.page_create(object_id, page_code, page_name, fields, ext_fields, props, can_create, can_update, can_delete, can_view, can_export,
            orderby, description,
            pybeforelist,
            pyafterlist,
