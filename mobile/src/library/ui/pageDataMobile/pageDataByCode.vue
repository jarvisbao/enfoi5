<template>
  <div>
      ...
      >
        ...
        <template #right>
          <div style="position: relative; display: flex;">
            ...
            <div v-show="topRight" style="position: absolute; top: 25px; background: #eee; right: -50%; border-radius: 10px; width: 100px;" class="">
    ...
    <van-sticky v-if="(can_create && !is_view) || can_export || newOtherMethods.length > 0" :offset-top="46" :z-index="98">
      ...
      <div ref="topBtnList" class="btn-list">
        <div v-show="can_create&&!is_view" id="create" class="button" @click="create">
          新建
        </div>
