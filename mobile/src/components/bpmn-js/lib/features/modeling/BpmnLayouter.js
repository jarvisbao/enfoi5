...
BpmnLayouter.prototype.layoutConnection = function(connection, hints) {
  ...
  var target = hints.target || connection.target
  var waypoints = hints.waypoints || connection.waypoints
  var connectionStart = hints.connectionStart
  var connectionEnd = hints.connectionEnd
...
function getBoundaryEventPreferredLayouts(source, target, end) {
  ...
  var attachOrientation = getAttachOrientation(source)
  var sourceLayout
  var targetLayout
...
function getBoundaryEventLoopLayout(attachOrientation, attachedToSide, source, target, end) {
  ...
  var sourceLayout = orientationDirectionMapping[ orientation ]
  var targetLayout
