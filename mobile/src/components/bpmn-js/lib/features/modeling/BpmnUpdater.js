...
export default function BpmnUpdater(
  ...
  this.executed('connection.reconnect', ifBpmn(function(event) {
    ...
    var oldSourceBo = getBusinessObject(oldSource)
...
BpmnUpdater.prototype.updateParent = function(element, oldParent) {
  ...
  var parentBusinessObject = parentShape && parentShape.businessObject
...
BpmnUpdater.prototype.updateConnection = function(context) {
  ...
  var newSource = getBusinessObject(connection.source)
  var newTarget = getBusinessObject(connection.target)
  var visualParent
