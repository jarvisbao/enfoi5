...
export default function DataInputAssociationBehavior(eventBus, bpmnFactory) {
  ...
  function fixTargetRef(event) {
    ...
    var targetBo = target && target.businessObject
    var newTarget = context.newTarget
    var newTargetBo = newTarget && newTarget.businessObject
    var oldTarget = context.oldTarget || context.target
    var oldTargetBo = oldTarget && oldTarget.businessObject
