  ...
  forEach(replaceOptions, function(entry) {
    switch (entry.actionName) {
      ...
      case 'replace-with-conditional-flow':
        if (!businessObject.conditionExpression && (is(businessObject.sourceRef, 'bpmn:Activity') || is(businessObject.sourceRef, 'bpmn:ExclusiveGateway'))) {
          menuEntries.push(self._createMenuEntry(entry, element, function() {
      ...
      default:
      // default flows
        if ((is(businessObject.sourceRef, 'bpmn:Activity') || is(businessObject.sourceRef, 'bpmn:ExclusiveGateway')) && businessObject.conditionExpression) {
