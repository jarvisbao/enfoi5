...
export default function LabelBehavior(
  ...
  this.postExecute('shape.delete', function(event) {
    ...
    var labelTarget = context.labelTarget
    var hints = context.hints || {}
  ...
  function getVisibleLabelAdjustment(event) {
    ...
    var hints = assign({}, context.hints)
    var newWaypoints = context.newWaypoints || connection.waypoints
    var oldWaypoints = context.oldWaypoints
