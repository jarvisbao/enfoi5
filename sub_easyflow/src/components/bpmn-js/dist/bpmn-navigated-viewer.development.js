/*!
 * bpmn-js - bpmn-navigated-viewer v6.4.1
 *
...
(function(global, factory) {
  ...
  function setAttributes(node, attrs) {
	  var names = Object.keys(attrs); var i; var name
  ...
  function extend(object, props) {
	  var i; var k; var keys = Object.keys(props)
  ...
  ClassList$1.prototype.remove = function(name) {
	  if (toString$1.call(name) == '[object RegExp]') {
	    return this.removeMatching(name)
	  }
  ...
  Text.prototype.layoutText = function(text, options) {
	  var box = assign({}, this._config.size, options.box)
	      var style = assign({}, this._config.style, options.style)
	      var align = parseAlign(options.align || this._config.align)
	      var padding = parsePadding(options.padding !== undefined ? options.padding : this._config.padding)
	      var fitBox = options.fitBox || false
  ...
  BpmnImporter.prototype.add = function(semantic, parentElement) {
	  ...
	  // CONNECTION
	    ...
	    var source = this._getSource(semantic)
	        var target = this._getTarget(semantic)
  ...
  function SelectionBehavior(
	  ...
	  eventBus.on('create.end', 500, function(e) {
	    var context = e.context
	        var canExecute = context.canExecute
	        var elements = context.elements
	        var hints = context.hints || {}
	        var autoSelect = hints.autoSelect
	  ...
	  eventBus.on('element.click', function(event) {
	    ...
	    var isSelected = selection.isSelected(element)
	        var isMultiSelect = selection.get().length > 1
  ...
  Overlays.prototype._updateOverlay = function(overlay) {
	  var position = overlay.position
	      var htmlContainer = overlay.htmlContainer
  ...
  Overlays.prototype._updateOverlayVisibilty = function(overlay, viewbox) {
	  var show = overlay.show
	      var minZoom = show && show.minZoom
	      var maxZoom = show && show.maxZoom
	      var htmlContainer = overlay.htmlContainer
	      var visible = true
  ...
  function Injector(modules, parent) {
	  ...
	  var instantiate = function instantiate(Type) {
	    var _fnDef = fnDef(Type)
	        var dependencies = _fnDef.dependencies
	        var fn = _fnDef.fn
	  ...
	  var invoke = function invoke(func, context, locals) {
	    var _fnDef2 = fnDef(func, locals)
	        var dependencies = _fnDef2.dependencies
	        var fn = _fnDef2.fn
  ...
  DefaultRenderer.prototype.getConnectionPath = function getConnectionPath(connection) {
	  ...
	  var idx; var point; var connectionPath = []
  ...
  ElementRegistry.prototype.updateId = function(element, newId) {
	  ...
	  var gfx = this.getGraphics(element)
	      var secondaryGfx = this.getGraphics(element, true)
  ...
  var parentRefs = new objectRefs({ name: 'children', enumerable: true, collection: true }, { name: 'parent' })
	    var labelRefs = new objectRefs({ name: 'labels', enumerable: true, collection: true }, { name: 'labelTarget' })
	    var attacherRefs = new objectRefs({ name: 'attachers', collection: true }, { name: 'host' })
	    var outgoingRefs = new objectRefs({ name: 'outgoing', collection: true }, { name: 'source' })
	    var incomingRefs = new objectRefs({ name: 'incoming', collection: true }, { name: 'target' })
  ...
  Factory.prototype.createType = function(descriptor) {
	  ...
	  var props = this.properties
	      var prototype = Object.create(Base$1.prototype)
  ...
  ElementHandler.prototype.createElement = function(node) {
	  var attributes = node.attributes
	      var Type = this.type
	      var descriptor = getModdleDescriptor(Type)
  ...
  BaseViewer.prototype.saveSVG = function(options, done) {
	  ...
	  try {
	    ...
	    var contentNode = canvas.getDefaultLayer()
	        var defsNode = query('defs', canvas._svg)

	    var contents = innerSVG(contentNode)
	        var defs = defsNode ? '<defs>' + innerSVG(defsNode) + '</defs>' : ''
  ...
  function MoveCanvas(eventBus, canvas) {
	  ...
	  function handleMove(event) {
	    var start = context.start
	        ...
	        var delta$1 = delta(position, start)
  ...
  function getStepSize(range, steps) {
	  var minLinearRange = log10(range.min)
	      var maxLinearRange = log10(range.max)
